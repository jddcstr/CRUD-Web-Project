    ...
    <body>
        ...
        <div class="dashboard-container">
            <div class="dashboard-card">
                <form action="<%=request.getContextPath()%>/UpdateServlet" method="post" class="form-group">
                    <input type="text" name="email" placeholder="Email to Update" class="form-input" required>
